...
AFRAME.registerComponent('butterfly-keyboard', {
  ...
  accept: function () {
    ...
    var self = this;
    // the piece resets and waits for the next visitor. v7 pulled this
    // delay into config.js (CFG.acceptResetDelay, default 3200 -- no
    // change) so the "watch your butterfly join the kaleidoscope" beat
    // can be tuned against collection.js's fly-in.
