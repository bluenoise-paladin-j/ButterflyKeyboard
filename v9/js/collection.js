...
AFRAME.registerComponent('butterfly-collection', {
  ...
  //  Just off the palm, along its own normal -- so it sits ON a tilted
  //  hand rather than hovering level above it.
  perchPoint: function (c, hand, out) {
    return out.copy(hand.pos).addScaledVector(hand.normal, CFG.perchLift);
  },
