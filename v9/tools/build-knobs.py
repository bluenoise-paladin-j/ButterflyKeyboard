...
FILES = [
 dict(f='js/config.js', hue=214, blurb='Every number the piece is built from. 173 keys. Almost everything you will want to move is here.', groups=[
  ...
  ('…no hand: it hovers in front of you', [
   ('hoverDist','0.62',616,"Metres in front — inside the keyboard's 1.00 orbit.",'new'),
   ('hoverRise','0.08',617,"Metres ABOVE the eye line. Below it, a butterfly at 0.62 m covers the name field and the two controls.",'new'),
   ('hoverSize','0.62',618,"Held at a comfortable size, whatever its orbit size is.",'new'),
   ('hoverDwell','7.0',619,"Seconds it waits for a hand before it gives up and leaves.",'new'),
   ('hoverDrift','0.055',620,"Metres it wanders around the held spot, on the noise it already flies its orbit with.",'new'),
   ('hoverFlap','7.5',621,"Radians/sec — slower than flight (18–27), faster than the reveal's breath (1.9).",'new'),
   ('hoverFlapAmp','0.50',622,"Dihedral of that beat.",'new'),
   ('hoverFlapMean','-0.35',623,"Wings held a little up while hovering. Negative is wings-up in bm.flap's convention.",'new'),
  ]),
  ('…a hand: it lands on it', [
   ('perchSize','0.50',635,"About 18 cm across the wings against a ~9 cm palm. THE number to move if the perch looks wrong in the headset.",'new'),
