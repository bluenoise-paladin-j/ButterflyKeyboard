...
FILES = [
 dict(f='js/config.js', hue=214, blurb='Every number the piece is built from. 173 keys. Almost everything you will want to move is here.', groups=[
  ...
  ('…no hand: it hovers in front of you', [
   ...
   ('hoverSpanX','0.26',683,"Metres it wanders side to side. IT FLIES while it waits — the first pass held it in the reveal's flat pinned-specimen pose and it read as a diagram of a butterfly rather than a butterfly.",'new'),
   ('hoverSpanY','0.15',684,"Metres up and down.",'new'),
   ('hoverSpanZ','0.11',685,"Metres toward and away — least, or it keeps changing size.",'new'),
   ('hoverRate','20',690,"Multiplies the butterfly's OWN orbit noise frequencies, so no two wait the same way. Measured over the full 7 s wait: 20 buys the widest swing (0.24 m) at the same peak speed as slower rates (0.36 m/s). Past ~26 the peak climbs and it reads as darting, 0.6 m from a face.",'new'),
   ('hoverEase','0.22',691,"Seconds of lag onto the wandering point. Gives the movement weight, and smooths the heading the body turns to follow — steering the position directly would leave the heading chasing noise.",'new'),
   ('hoverSettle','0.7',692,"Seconds the wander ramps in over as it arrives. Without it the target jumps on the first frame of the hover and it lunges at the visitor's face at 1.0 m/s; ramped, the peak over the whole wait is 0.36.",'new'),
  ]),
  ('…a hand: it lands on it', [
   ...
   ('perchSize','0.50',716,"About 18 cm across the wings against a ~9 cm palm. THE number to move if the perch looks wrong in the headset.",'new'),
   ('perchLift','0.018',636,"Metres above the palm plane the body sits, along the palm's own normal.",'new'),
