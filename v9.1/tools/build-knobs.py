...
FILES = [
 dict(f='js/config.js', hue=214, blurb='Every number the piece is built from. 173 keys. Almost everything you will want to move is here.', groups=[
  ...
  ('…a hand: it lands on it', [
   ...
   ('perchLegDrop','0.1406',754,"IT STANDS ON ITS LEGS. Per unit model size, how far the lowest leg tip hangs below the model's origin — and the origin is the WING HINGE, so placing that on the palm (which the first pass did) buried the body and every leg in the hand, about 52 mm of it. Measured off BODY_ALPHA itself: decode it, threshold at the material's own alphaTest of 0.5, and the lowest painted pixel is at local y −0.1406. Cross-check: tagBodyDrop, measured independently for the name tag, is −0.135.",'new'),
   ('perchLift','0.002',755,"Metres of clearance between that leg tip and the palm. Negative sinks it in.",'new'),
