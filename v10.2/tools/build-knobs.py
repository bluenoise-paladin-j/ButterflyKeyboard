...
FILES = [
 dict(f='js/config.js', hue=214, blurb='Every number the piece is built from. 213 keys. Almost everything you will want to move is here.', groups=[
  ...
  ('the session — v10’s guide, and the voice that runs it', [
   ('guideQuietMs','10000',917,"Milliseconds of no interaction before the nudge. v10.2: was 30000 — fifteen seconds from the last thing a visitor did to the room handing over, where v10 took forty-five. Ending is non-destructive, so the cost of ending early is that they press the flower again. This and the headset coming off are now the only two ends there are.",'changed'),
   ('guideQuietGrace','5000',918,"...and this much more before the farewell. ANY activity cancels and puts the session back. v10.2: was 15000.",'changed'),
