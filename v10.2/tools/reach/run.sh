...
#    test-fist.js    v10.2's staff reset -- and specifically whether a
#                    closed fist collides with a PINCH, which is the only
#                    real question the gesture posed.
...
#
#  Run it after touching hands.js, interact.js, guide.js or
...
fail=0
for t in test-palm test-flight test-pick test-fist test-guide; do
  echo "======== $t ========"
