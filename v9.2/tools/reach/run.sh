...
#
#  Run it after touching hands.js, interact.js or collection.js's
#  states. It is fast (a second or so) and needs nothing installed.
#
...
fail=0
for t in test-palm test-flight test-pick; do
  echo "======== $t ========"
